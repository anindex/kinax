...
import kinax
from kinax.model import FRANKA_PANDA_NO_GRIPPER, TIAGO_DUAL_WHEEL, FRANKA_PANDA, UR10, UR5, TIAGO_DUAL_HOLO, SHADOW_HAND, ALLEGRO_HAND, PLANAR_2_LINK, BAXTER
